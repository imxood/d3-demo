<script type="ts">
    ...
    onDestroy(() => {
        console.log("onDestroy Chart04");
    });

    onMount(() => {
        console.log("onMount Chart04");
        redraw();
    });
    ...
    function makeHistogram(
        ...
        // const exitBinGroups = binGroups.exit();
        ...
        // exitBinGroups.transition(exitTransition).remove();
